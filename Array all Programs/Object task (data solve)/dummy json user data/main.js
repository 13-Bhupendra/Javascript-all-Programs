...
for (let i = 0; i < json_recipe.recipes.length; i++) {

  document.write("<h1> Recipe Name : " + json_recipe.recipes[i].name + "</h1>")
  document.write("Recipe ID :-  " + json_recipe.recipes[i].id + "<br>")
  document.write("<h3><u>Ingredients :- </h3> </u>" + json_recipe.recipes[i].ingredients + "<br>")
  document.write("<h3><u>Introduction :- </h3></u> " + 
    "<p>Preheat the oven to 475°F (245°C). Roll out the pizza dough and spread tomato sauce evenly. Top with slices of fresh mozzarella and fresh basil leaves. Drizzle with olive oil and season with salt and pepper. Bake in the preheated oven for 12-15 minutes or until the crust is golden brown. Slice and serve hot.</p>" )

  document.write("PrepTimeMinutes :-  " + json_recipe.recipes[i].prepTimeMinutes + "<br>")
  document.write("CookTimeMinutes :-  " + json_recipe.recipes[i].cookTimeMinutes + "<br>")
  document.write("servings :-  " + json_recipe.recipes[i].servings + "<br>")
  document.write("difficulty :-  " + json_recipe.recipes[i].difficulty + "<br>")
  document.write("cuisine :-  " + json_recipe.recipes[i].cuisine + "<br>")
  document.write("caloriesPerServing :-  " + json_recipe.recipes[i].caloriesPerServing + "<br>")

  document.write("<h3><u>User InFo  :- </h3></u>")
  document.write("User id  :-  " + json_recipe.recipes[i].userId + "<br>")
  document.write("Rating  :-  " + json_recipe.recipes[i].rating + "<br>")
  document.write("ReviewCount :-  " + json_recipe.recipes[i].reviewCount + "<br>")
  document.write("MealType :-  " + json_recipe.recipes[i].mealType + "<br>")
